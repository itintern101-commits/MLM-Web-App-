...
import { ServerTelemetryManager, enforceResourceParameter, AuthError, Constants as Constants$1, ServerError, AADServerParamKeys } from '@azure/msal-common/node';
    ...
    async acquireTokenInteractive(request) {
        ...
        if (this.nativeBrokerPlugin) {
            const brokerRequest = {
                ...
                scopes: request.scopes || Constants$1.OIDC_DEFAULT_SCOPES,
        ...
        try {
            ...
            const validRequest = {
                ...
                responseMode: Constants$1.ResponseMode.QUERY,
                codeChallenge: challenge,
                codeChallengeMethod: Constants$1.CodeChallengeMethodValues.S256,
            };
