...
import { createClientAuthError, getClientAssertion, Constants as Constants$1, UrlString, AuthError } from '@azure/msal-common/node';
import { ClientCredentialClient } from './ClientCredentialClient.mjs';
import { OnBehalfOfClient } from './OnBehalfOfClient.mjs';
import { invalidClientCredential, missingTenantIdError } from '../error/ClientAuthErrorCodes.mjs';
...
class ConfidentialClientApplication extends ClientApplication {
    ...
    async acquireTokenByClientCredential(request) {
        ...
        const validBaseRequest = {
            ...baseRequest,
            scopes: baseRequest.scopes.filter((scope) => !Constants$1.OIDC_DEFAULT_SCOPES.includes(scope)),
        };
        const validRequest = {
            ...request,
            ...validBaseRequest,
        ...
        if (Object.values(Constants$1.AADAuthority).includes(tenantId)) {
