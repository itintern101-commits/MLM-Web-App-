...
'use strict';
import { TimeUtils, ResponseHandler, UrlString, CcsCredentialType, RequestParameterBuilder, Constants, getClientAssertion, StringUtils, UrlUtils } from '@azure/msal-common/node';
...
class UsernamePasswordClient extends BaseClient {
    ...
    async createTokenRequestBody(request) {
        ...
        RequestParameterBuilder.addResponseType(parameters, Constants.OAuthResponseType.IDTOKEN_TOKEN);
        RequestParameterBuilder.addGrantType(parameters, Constants.GrantType.RESOURCE_OWNER_PASSWORD_GRANT);
