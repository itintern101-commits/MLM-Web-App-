...
'use strict';
import { TimeUtils, Constants, AuthError, createClientAuthError, ClientAuthErrorCodes, ResponseHandler, StubPerformanceClient, UrlString } from '@azure/msal-common/node';
import { ManagedIdentityQueryParameters, HttpMethod, ApiId, ManagedIdentityIdType } from '../../utils/Constants.mjs';
