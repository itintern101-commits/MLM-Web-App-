...
'use strict';
import { TimeUtils, ResponseHandler, UrlString, RequestParameterBuilder, UrlUtils, createClientAuthError, Constants, createAuthError, AuthErrorCodes, StringUtils } from '@azure/msal-common/node';
import { ApiId } from '../utils/Constants.mjs';
import { deviceCodePollingCancelled, userTimeoutReached, deviceCodeExpired, deviceCodeUnknownError } from '../error/ClientAuthErrorCodes.mjs';
...
class DeviceCodeClient extends BaseClient {
    ...
    createTokenRequestBody(request, deviceCodeResponse) {
        ...
        RequestParameterBuilder.addScopes(parameters, request.scopes);
        RequestParameterBuilder.addClientId(parameters, this.config.authOptions.clientId);
        RequestParameterBuilder.addGrantType(parameters, Constants.GrantType.DEVICE_CODE_GRANT);
