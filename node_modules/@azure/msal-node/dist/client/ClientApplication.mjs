...
'use strict';
import { Logger, buildStaticAuthorityOptions, Constants, AuthorizationCodeClient, StubPerformanceClient, AuthError, RefreshTokenClient, SilentFlowClient, ClientAuthError, ClientAuthErrorCodes, createClientAuthError, getClientAssertion, ServerTelemetryManager, Authority, AuthorityFactory } from '@azure/msal-common/node';
...
class ClientApplication {
    ...
    async createAuthority(authorityString, requestCorrelationId, azureRegionConfiguration, azureCloudOptions) {
        ...
        return AuthorityFactory.createDiscoveredInstance(authorityUrl, this.config.system.networkClient, this.storage, authorityOptions, this.logger, requestCorrelationId, new StubPerformanceClient());
    }
    /**
     * Clear the cache
     */
