...
import { createClientAuthError, TimeUtils, Constants } from '@azure/msal-common/node';
import { EncodingUtils } from '../utils/EncodingUtils.mjs';
import { JwtConstants } from '../utils/Constants.mjs';
import { invalidAssertion } from '../error/ClientAuthErrorCodes.mjs';
...
class ClientAssertion {
    ...
    createJwt(cryptoProvider, issuer, jwtAudience) {
        ...
        Object.assign(header, {
            [thumbprintHeader]: EncodingUtils.base64EncodeUrl(this.thumbprint, Constants.EncodingTypes.HEX),
        });
