...
'use strict';
import { ScopeSet, Constants, createClientAuthError, ClientAuthErrorCodes, TimeUtils, AuthToken, ResponseHandler, UrlString, RequestParameterBuilder, AADServerParamKeys, getClientAssertion, UrlUtils } from '@azure/msal-common/node';
...
class OnBehalfOfClient extends BaseClient {
    ...
    async getCachedAuthenticationResult(request) {
        ...
        if (!cachedAccessToken) {
            ...
            this.serverTelemetryManager?.setCacheOutcome(Constants.CacheOutcome.NO_CACHED_ACCESS_TOKEN);
            ...
            this.serverTelemetryManager?.setCacheOutcome(Constants.CacheOutcome.CACHED_ACCESS_TOKEN_EXPIRED);
    ...
    async createTokenRequestBody(request) {
        ...
        RequestParameterBuilder.addGrantType(parameters, Constants.GrantType.JWT_BEARER);
